...
$handle = $link->prepare('SELECT firmalar.firmalar as x, firmalar.firma_id as y
from firmalar,tanim
WHERE firmalar.tanim_id=tanim.tanim_id AND tanim.tanim_id=1
GROUP BY firmalar.firma_id
ORDER BY firmalar.tanim_id DESC
LIMIT 3');
$handle->execute();
...
<head><title>Eczane Depo Sistemi</title>
 ...
 <script>
            ...
            title:{
            text: "En Çok Tercih Edilen 3 Firma"
            },
            data: [{
...
<div id="chartContainer7" style="height: 200px; width: 40%; margin-top: 30px;  margin-left:300px;"></div>
<button style="width:100px; margin-right:100px; margin-top:50px;" onclick="myFunction()">Mesaj</button>
